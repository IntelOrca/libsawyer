...
protected:
    ...
    void assertDecode(stdx::span<uint8_t const> encodedData, stdx::span<uint8_t const> expectedData)
    {
        ...
        ASSERT_EQ(decodedData.size(), expectedData.size());

        // Check data is correct
        auto result = std::memcmp(decodedData.data(), expectedData.data(), expectedData.size());
        ASSERT_EQ(result, 0);
    }
...
TEST_F(SawyerStreamTests, write_read_chunk_none)
{
    assertEncodeDecode(cs::SawyerEncoding::uncompressed, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, write_read_chunk_rle)
{
    assertEncodeDecode(cs::SawyerEncoding::runLengthSingle, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, write_read_chunk_rle_compressed)
{
    assertEncodeDecode(cs::SawyerEncoding::runLengthMulti, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, write_read_chunk_rotate)
{
    assertEncodeDecode(cs::SawyerEncoding::rotate, stdx::span{ randomdata });
}
...
TEST_F(SawyerStreamTests, decode_chunk_none)
{
    assertDecode(stdx::span{ nonedata }, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, decode_chunk_rle)
{
    assertDecode(stdx::span{ rledata }, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, decode_chunk_rlecompressed)
{
    assertDecode(stdx::span{ rlecompresseddata }, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, decode_chunk_rotate)
{
    // Rotate
    assertDecode(stdx::span{ rotatedata }, stdx::span{ randomdata });
}

TEST_F(SawyerStreamTests, DISABLED_invalid1)
{
    assertDecodeException(stdx::span{ invalid1 });
}

TEST_F(SawyerStreamTests, invalid2)
{
    assertDecodeException(stdx::span{ invalid2 });
}

TEST_F(SawyerStreamTests, invalid3)
{
    assertDecodeException(stdx::span{ invalid3 });
}

TEST_F(SawyerStreamTests, invalid4)
{
    assertDecodeException(stdx::span{ invalid4 });
}

TEST_F(SawyerStreamTests, DISABLED_invalid5)
{
    assertDecodeException(stdx::span{ invalid5 });
}

TEST_F(SawyerStreamTests, invalid6)
{
    assertDecodeException(stdx::span{ invalid6 });
}

TEST_F(SawyerStreamTests, invalid7)
{
    assertDecodeException(stdx::span{ invalid7 });
}

TEST_F(SawyerStreamTests, empty)
{
    assertDecodeException(stdx::span{ empty });
}

// clang-format off
// 1024 bytes of random data
// use `dd if=/dev/urandom bs=1024 count=1 | xxd -i` to get your own
const uint8_t SawyerStreamTests::randomdata[] = {
...
const uint8_t SawyerStreamTests::nonedata[] = {
...
const uint8_t SawyerStreamTests::rledata[] = {
...
const uint8_t SawyerStreamTests::rlecompresseddata[] = {
...
const uint8_t SawyerStreamTests::rotatedata[] = {
...
const uint8_t SawyerStreamTests::invalid1[] = { 0x02, 0x04, 0x00, 0x00, 0x00, 0xd4, 0xff, 0xce, 0xcf, 0x2e, 0x00 };

const uint8_t SawyerStreamTests::invalid2[] = { 0x02, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x27, 0x3f, 0x01, 0x00 };

const uint8_t SawyerStreamTests::invalid3[] = { 0x02, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00,
                                               0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x73 };

const uint8_t SawyerStreamTests::invalid4[] = { 0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00 };

const uint8_t SawyerStreamTests::invalid5[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0xdf, 0x00, 0x00 };

const uint8_t SawyerStreamTests::invalid6[] = { 0x02, 0x02, 0x00, 0x00, 0x00, 0x28, 0x7f };

const uint8_t SawyerStreamTests::invalid7[] = { 0x01, 0x01, 0x00, 0x00, 0x00, 0x00 };

// This needs to be non-empty to satisfy MSVC. We still pass zero as length.
const uint8_t SawyerStreamTests::empty[] = { 0x00 };
// clang-format on
